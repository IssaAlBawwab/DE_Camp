...
def main():
    ...
    df_green = spark.read.parquet(input_green).withColumnRenamed('lpep_pickup_datetime', 'pickup_datetime') \
                                             .withColumnRenamed('lpep_dropoff_datetime', 'dropoff_datetime')

    df_yellow = spark.read.parquet(input_yellow).withColumnRenamed('tpep_pickup_datetime', 'pickup_datetime') \
